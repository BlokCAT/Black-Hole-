...
void Shader::setUniformCubeMap(const std::string& name, unsigned int textureUnit)
{
	GLint location = CK(glGetUniformLocation(mProgram, name.c_str()));
	glUniform1i(location, (GLint)textureUnit);
}

void Shader::setUniformTexture2D(const std::string& name, unsigned int textureUnit)
{
	GLint location = CK(glGetUniformLocation(mProgram, name.c_str()));
	glUniform1i(location, (GLint)textureUnit);
}
