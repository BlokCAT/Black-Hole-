...
Mesh::Mesh(std::vector<Vertex> vertices, std::vector<unsigned int> indices, std::vector<Texture> textures , float mshininess)
{
...
void Mesh::Draw(Shader& shader)
{
    ...
    for (unsigned int i = 0; i < textures.size(); i++) 
    {
        ...
        shader.setUniformFloat("material.shininess",this->shininess);
